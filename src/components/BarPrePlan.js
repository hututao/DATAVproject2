...
const transBarPrePlan = (data) => {
    ...
    data.forEach((item) => {
        ...
        const musicgenre = item.preffered_premium_plan;

        if (!result[key]) {
            result[key] = {
                'Family Plan-Rs 179/month': 0,
                'Individual Plan- Rs 119/ month': 0,
                'Student Plan-Rs 59/month': 0,
...
const BarPrePlan = ({ data }) => {
    const categories = [
        'Family Plan-Rs 179/month',
        'Individual Plan- Rs 119/ month',
        'Student Plan-Rs 59/month',
        'Duo plan- Rs 149/month',
        'None'
    ];
...
export { BarPrePlan, transBarPrePlan };